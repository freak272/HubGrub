      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full max-w-xl">
        ...
        >
          ...
          <div className="text-center">
            <div className="text-xl font-semibold mb-1">Continue as Customer</div>
            <div className="text-sm text-muted-foreground leading-snug">Browse products and place your order</div>
          </div>
        </button>
